    ...
    <footer>
      <div className="footer-grid">
        ...
        <div className="footer-brand">
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: '0.18em', color: 'rgba(245,240,232,0.25)', marginBottom: 10 }}>
            TRUTH ON-CHAIN · SHELBY PROTOCOL
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: '0.14em', color: 'rgba(245,240,232,0.3)' }}>
            build by:
            {/* X / Twitter */}
            <a
